...
def segment_check(start_index, end_index, node_left, node_right, node):
    ...
    return segment_check(start_index, end_index, node_left, mid, node * 2) + segment_check(start_index, end_index, mid + 1, node_right, node * 2 + 1)
...
for _ in range(M):
    ...
    if nums[0] == 1:
        ...
        print(segment_check(start_index, end_index, 1, base, 1))